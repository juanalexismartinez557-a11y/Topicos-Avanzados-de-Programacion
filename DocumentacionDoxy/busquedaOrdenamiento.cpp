/**
 * @mainpage Proyecto de Análisis de Complejidad Algorítmica
 *
 * @section intro Introducción
 *
 * Este proyecto implementa algoritmos de búsqueda y ordenamiento,
 * junto con un generador de números aleatorios configurable.
 *
 * Se analiza la complejidad computacional de cada algoritmo
 * y se mide el tiempo de ejecución utilizando la librería <chrono>.
 *
 ...
 * - MergeSort
 *
 * @author Angel Iván Pintor Flores, Luisa Xiomara Chavez Cano, Juan Alexis Martinez Moran, Andre Hernandez Constantini.
 * @date 2025
 */
 ...
 *
 * Controla la configuración inicial, generación de números,
 * menú interactivo y ejecución de algoritmos de búsqueda y ordenamiento.
 *
 * @return int Código de finalización del programa.
 */
int main()
{
    int opcion;
